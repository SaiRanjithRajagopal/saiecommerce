...
const { registerUser, loginUser, logout, forgotPassword, resetPassword, getUserProfile, updatePassword, updateUserProfile, allUsers, getUserDetails } = require('../Controllers/UserController')
...
router.route('/user/updateprofilebyadmin').put(isAuthenticatedUser, authorizedRoles('admin'), updateUserProfile);
